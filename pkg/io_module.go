...
func bufferBytesImp(thread *Thread, registers, stack *Slice, pos Pos) error {
...
func bufferLengthImp(thread *Thread, registers, stack *Slice, pos Pos) error {
	stack.Push(NewVal(&TInt, Int(stack.Pop().data.(*Buffer).Len())))
	return nil
}

func bufferNewImp(thread *Thread, registers, stack *Slice, pos Pos) error {
	stack.Push(NewVal(&TBuffer, new(Buffer)))
	return nil
}

func byteToIntImp(thread *Thread, registers, stack *Slice, pos Pos) error {
	v := stack.Pop().data.(Byte)
	stack.Push(NewVal(&TInt, Int(v)))
	return nil
}

func intToByteImp(thread *Thread, registers, stack *Slice, pos Pos) error {
...
func slurpImp(thread *Thread, registers, stack *Slice, pos Pos) error {
...
func slurpReaderImp(thread *Thread, registers, stack *Slice, pos Pos) error {
	var b Buffer
...
func writeBufferImp(thread *Thread, registers, stack *Slice, pos Pos) error {
...
func writeStringImp(thread *Thread, registers, stack *Slice, pos Pos) error {
...
func writeByteImp(thread *Thread, registers, stack *Slice, pos Pos) error {
